...
async function fetchPlaylistTracks(playlistId: string): Promise<ProviderTrackItem[]> {
...
export async function getPlaylistTracks(url: string): Promise<ProviderPlaylistData> {
